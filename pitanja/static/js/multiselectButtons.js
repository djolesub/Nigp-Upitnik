$(document).ready(function(){
    ...
    //Postavljanje bele boje za dugme sa padajucom listom
    ...
    $('#id_form11-Digitalni_Format_modal, #id_form11-Metapodaci_modal, #id_form11-Naknada_modal').wrap("<label></label>");

    $('#formUpitnik input').after("<span></span>");
    $('#modalForm input').after("<span></span>");
        ...
        onChange: function(element, checked) {
            ...
            $(brands).each(function(index, brand) {
                if ($(this).val() == "Остало") {
                    ...
                    $('.modal-body #div_id_form11-Nacin_skladistenja_ostalo_modal').css('display', 'none');
...
/////Dostupost
    ...
    $('.modal-body ul li a label input').after('<span></span>');
